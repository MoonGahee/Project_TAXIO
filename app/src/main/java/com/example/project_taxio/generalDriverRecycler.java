...
public class generalDriverRecycler extends RecyclerView.Adapter<RecyclerRecruitDriver.ItemViewHolder>{
// 주석 체크만 한 경우 ViewHolder > itemViewHolder로 변경함
private ArrayList<DriverItem> dData = new ArrayList<>();
        Context context;
...
public class ItemViewHolder extends RecyclerView.ViewHolder{ //
    ...
    void addData(DriverItem data){ // 1. RecruitDriver에서 호출 > 2. DriverData값을 가져와서 > 3. 이 곳에 DriverData를 추가
        dData.add(data);
    }
}
